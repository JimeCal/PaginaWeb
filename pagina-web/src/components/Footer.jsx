        ...
        <footer className="bg-[#92B0C9] text-gray-900 py-8 px-4">
            ...
            <div className="flex items-center justify-center space-x-6 mt-8 mb-2">
                ...
                <a href="#" aria-label="Whatsapp">
                    <svg width="20" height="20" viewBox="0 0 64 64" fill="#001C36" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#" aria-label="Facebook">
                    <svg width="20" height="20" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="32" cy="32" r="30" fill="#001C36" />
                        <path d="M38 22h-5a5 5 0 0 0-5 5v5h-5v7h5v11h7V39h5l2-7h-7v-5a2 2 0 0 1 2-2h5z" />
                    </svg>
                </a>
                <a href="#" aria-label="Instagram">
                    <svg className="w-20 h-20" /* Instagram SVG */ />
                </a>
            </div>
